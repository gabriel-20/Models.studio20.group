                            ...
                            @foreach($AnalyticsVisitors as $Analytic)
                                <tr>
                                    <td class="text-center" >
                                        <small>{{$Analytic->date}} &nbsp;</small>
                                    </td>
                                    <td class="text-center dker text-info"><a href="{{route("visitorsIP",$Analytic->ip)}}">{{$Analytic->ip}}</a></td>


                                    <td>
                                        <label class="switch"><input type="checkbox" class="btnVerif" value="0"> <span class="slider round"></span></label>
                                        {{--@if ($Analytic->ban == 0) <label class="switch"><input type="checkbox" class="btnVerif" value="{{$Analytic->ip}}"> <span class="slider round"></span></label>--}}
                                        {{--@else <label class="switch"><input type="checkbox" checked="checked" class="btnVerif" value="{{$Analytic->ip}}"> <span class="slider round"></span></label>--}}
                                        {{--@endif--}}
                                    </td>
