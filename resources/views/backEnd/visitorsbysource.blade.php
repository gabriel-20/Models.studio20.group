                    ...
                    <div>
                        ...
                        <table id="visitors">
                            ...
                            @foreach($AnalyticsVisitors as $Analytic)
                                <tr>
                                    {{--<td>{{ $ind++ }} </td>--}}
                                    <td>{{ $Analytic->source }} </td>
                                    <td>{{ $Analytic->total }} </td>
                                    {{--<td>{{ $Analytic->medium }} </td>--}}
...
{{--<script src="{{ URL::to("backEnd/libs/jquery/bootstrap-daterangepicker/moment.min.js") }}" type="text/javascript"></script>--}}
{{--<script src="{{ URL::to("backEnd/libs/jquery/bootstrap-daterangepicker/daterangepicker.js") }}" type="text/javascript"></script>--}}
