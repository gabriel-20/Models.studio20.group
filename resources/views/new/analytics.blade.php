...
@section('headerInclude')
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::asset('/gleek/assets/images/adminfavicon.ico') }}">
    <!-- style -->
    ...
    <link href="{{ URL::to("backEnd/libs/jquery/bootstrap-daterangepicker/daterangepicker-bs3.css") }}" rel="stylesheet" type="text/css"/>
