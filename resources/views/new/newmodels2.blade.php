        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col p-md-0">
                    <h4>New Models - Last 15 Days - Under 50h Online Time</h4>
                </div>
                <div class="col p-md-0">
                    <ol class="breadcrumb">
...
<script>
    ...
    function newdata(array){
        ...
        array.forEach(function(element) {
            ...
            let totalTime = element.totalTime15;
            let totalTime1 = element.newTime;


            if ( ((status === 'private_chat') || (status === 'free_chat') || (status === 'offline')) && (totalTime1 <= 180000) ){
                ...
                let modelHits = 0;
                let StudioName = element.name;

                let result = calctime(totalTime);

                let result2 = calctime(totalTime1);
                ...
                let modelName = (element.sync_Modelname);
                ...
                let ribon3 = $('<div />', {"class": 'ribbon ribbon-style-6',"style":"margin-top: 195px!important;background-color:#00a2ff!important"});
                let ribon4 = $('<div />', {"class": 'ribbon ribbon-style-6',"style":"margin-top: 235px!important;background-color:#00a2ff!important"});
                ...
                //let span2 = $('<span />', {"class": 'text-danger  mt-4',text: "TotalTime: "+result});
                let span2 = $('<div />', {"class": 'text-danger  mt-4',text: "NewTime: "+result2});



                aimg.append(img);
                h4ribon.append(span);
                h4ribon.append(span2);
                textcenter.append(newimg);
                textcenter.append(aimg);
                textcenter.append(h4);
                textcenter.append(h5studio);
                textcenter.append(span2);
    ...
    function calctime(ttime){

        let thours = Math.floor(ttime / 3600);
        ttime = ttime % 3600;
        let tminutes = Math.floor(ttime / 60);
        let tseconds = ttime % 60;
