            ...
            <ul>
                            ...
                            <ul>
                                <li class="notification-unread">
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="{{ URL::asset('/gleek/assets/images/avatar/1.jpg') }}" alt="">
                                ...
                                <li class="notification-unread">
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="{{ URL::asset('/gleek/assets/images/avatar/2.jpg') }}" alt="">
                                        <div class="notification-content">
                                ...
                                <li>
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="{{ URL::asset('/gleek/assets/images/avatar/3.jpg') }}" alt="">
                                        <div class="notification-content">
                                ...
                                <li>
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="{{ URL::asset('/gleek/assets/images/avatar/4.jpg') }}" alt="">
                                        <div class="notification-content">
                ...
                <li class="icons">
                    <a href="javascript:void(0)" class="log-user">
                        <img src="{{ URL::asset('/gleek/assets/images/avatar/1.jpg') }}" alt="">
