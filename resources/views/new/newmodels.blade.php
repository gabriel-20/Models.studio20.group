...
<script>
    ...
    function newdata(array){
        ...
        array.forEach(function(element) {
            ...
            if ( ((status === 'private_chat') || (status === 'free_chat') || (status === 'offline')) && (totalTime <= 180000) ){
                ...
                let span2 = $('<span />', {"class": 'text-danger  mt-4',text: "Time: "+result});
                let span3 = $('<span />', {"class": 'text-danger  mt-4',text: "Time: "+result2});
